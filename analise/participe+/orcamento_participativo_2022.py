# -*- coding: utf-8 -*-
"""orcamento-participativo-2022.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1OdyQ8v3g6IpMhkfTYf9QW4UR5w49y0FG
...
print("teste: ", df_subprefeituras_propostas.count())
...
print(desigualdade_data)

"""###Análise do índice de correlação entre as colunas do mapa da desigualdade
...
#print(desigualdade_subprefeitura_data)

def count_propostas_viaveis(nome_da_subprefeitura):
...
for s in subprefeituras:
  ...
  dado_desigualdade = {
      ...
      'Propostas viaveis' : count_propostas_viaveis(s)
  }
...
#participacao_subprefeitura_data = pd.concat([participacao_subprefeitura_data, desigualdade_subprefeitura_data], axis=1, join='inner')
...
plot = sn.heatmap(correlation[['Propostas por habitante','Propostas viaveis']], annot = True, fmt=".1f", linewidths=.6, center=0)
plot
